...
const MOCK_SAVED_SENDERS: SavedContact[] = [
  {
    ...
    address: { country: "México", street: "Av. Central 100", interiorNumber: "", zipCode: "06000", state: "CDMX", city: "CDMX", colony: "Centro", reference: "Edificio azul" },
  },
  {
    id: "s-2",
    ...
    phone: "5512340001",
    email: "norte@jbg.com",
    address: { country: "México", street: "Blvd. Industrial 200", interiorNumber: "A", zipCode: "64000", state: "Nuevo León", city: "Monterrey", colony: "Industrial", reference: "" },
  },
];
...
const MOCK_SAVED_RECIPIENTS: SavedContact[] = [
  {
    ...
    address: { country: "México", street: "Av. Reforma 123", interiorNumber: "", zipCode: "06600", state: "CDMX", city: "CDMX", colony: "Juárez", reference: "Frente al parque" },
  },
  {
    id: "r-2",
    name: "María López",
    ...
    address: { country: "México", street: "Calle Hidalgo 456", interiorNumber: "3B", zipCode: "64000", state: "Nuevo León", city: "Monterrey", colony: "Centro", reference: "" },
  },
];
...
const emptyAddress: AddressData = { country: "México", street: "", interiorNumber: "", zipCode: "", state: "", city: "", colony: "", reference: "" };
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <Select
                ...
                onValueChange={(v) => onAddressChange({ ...address, country: v, state: "" })}
              >
                <SelectTrigger>
            ...
            <div>
              ...
              <Select
                value={address.state}
                onValueChange={(v) => onAddressChange({ ...address, state: v })}
              >
                <SelectTrigger>
            ...
            <div>
              <Label htmlFor={`${title}-street`}>Calle y número</Label>
              <Input
                id={`${title}-street`}
            ...
            <div>
              <Label htmlFor={`${title}-interior`}>Número interior</Label>
              <Input
                id={`${title}-interior`}
                placeholder="Opcional"
                value={address.interiorNumber}
                onChange={(e) => onAddressChange({ ...address, interiorNumber: e.target.value })}
              />
            </div>
            <div>
            ...
            <div>
              <Label htmlFor={`${title}-colony`}>Colonia</Label>
              <Input
                id={`${title}-colony`}
                placeholder="Colonia"
                value={address.colony}
                onChange={(e) => onAddressChange({ ...address, colony: e.target.value })}
              />
            </div>
            <div>
