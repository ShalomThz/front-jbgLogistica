...
interface DriverFiltersProps {
  ...
  setFilter: <K extends keyof DriverFiltersState>(key: K, value: DriverFiltersState[K]) => void;
  onReset: () => void;
}
      ...
      <Sheet>
        ...
        <SheetContent side="right" className="overflow-y-auto">
          <SheetHeader>
            ...
            <SheetDescription>Filtra y ordena los conductores por diferentes criterios</SheetDescription>
          </SheetHeader>
