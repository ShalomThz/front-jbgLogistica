...
import { Navigation, Plus, RefreshCw } from "lucide-react";
import {
  Badge,
  Button,
  Table,
...
import { DeliveryRouteFilters } from "../components/delivery-route/DeliveryRouteFilters";
import { useDeliveryRouteFilters } from "../hooks/useDeliveryRouteFilters";
import type {
  RoutePrimitives,
  RouteStatus,
...
const INITIAL_DATA: RoutePrimitives[] = [
    ...
    stops: [
      {
        ...
        address: {
          ...
          country: "MX",
          reference: "",
          geolocation: { latitude: 19.43, longitude: -99.14, placeId: null },
        },
        isCompleted: true,
      },
      {
        ...
        address: {
          ...
          country: "MX",
          reference: "",
          geolocation: { latitude: 19.38, longitude: -99.18, placeId: null },
        },
        isCompleted: false,
      },
    ],
  ...
  },
  {
    id: "RUT-002",
    driverId: "DRV-002",
    origin: { latitude: 19.41, longitude: -99.17, placeId: null },
    status: "PLANNED",
    stops: [
      {
        id: "STP-003",
        ...
        address: {
          ...
          country: "MX",
          reference: "",
          geolocation: { latitude: 19.43, longitude: -99.19, placeId: null },
        },
        isCompleted: false,
      },
    ],
  ...
  },
  {
    id: "RUT-003",
    driverId: "DRV-003",
    origin: { latitude: 19.36, longitude: -99.16, placeId: null },
    status: "COMPLETED",
    stops: [
      {
        id: "STP-004",
        ...
        address: {
          ...
          country: "MX",
          reference: "",
          geolocation: { latitude: 19.35, longitude: -99.16, placeId: null },
        },
        isCompleted: true,
      },
      {
        ...
        address: {
          ...
          country: "MX",
          reference: "",
          geolocation: { latitude: 19.32, longitude: -99.18, placeId: null },
        },
        isCompleted: true,
      },
      {
        ...
        address: {
          ...
          country: "MX",
          reference: "",
          geolocation: { latitude: 19.38, longitude: -99.17, placeId: null },
        },
        isCompleted: true,
      },
    ],
...
type RouteFormData = Omit<
  RoutePrimitives,
  "id" | "createdAt" | "updatedAt" | "stops" | "mapsMetadata"
>;
...
export const DeliveryRoutesPage = () => {
  ...
  const { filters, setFilter, resetFilters, filtered } =
    useDeliveryRouteFilters(routes);
