...
/**
 * El picker muestra el catálogo completo, sin acotar por precio.
 *
 * Antes se filtraba a las cajas con tarifa en la zona de recolección, para que
 * el socio no eligiera una que después no se pudiera cotizar. Se quitó porque
 * el paso de paquete va antes que el de costos: ahí todavía no hay servicio ni
 * modo de transporte elegidos, así que el filtro tenía que asumirlos, y una
 * caja tarifada solo por mar o por aire desaparecía sin explicación.
 *
 * Elegir una caja sin tarifa no es un callejón: el paso de costos lo dice con
 * la card de "no se encontró tarifa" y el precio se escribe a mano.
 */
