...
export const useHQOrderFlow = ({ initialValues, orderId, storeId }: UseHQOrderFlowOptions = {}) => {
  ...
  return {
    ...
    isPartnerOrder: submission.isPartnerOrder,
    partnerPricing: submission.partnerPricing,
    partnerTariff: submission.partnerTariff,
    ...
    tariffShippingMode: submission.tariffShippingMode,
    tariffDestinationCountry: submission.tariffDestinationCountry,
    setDestinationCountry: submission.setDestinationCountry,
    recipientCountry: submission.recipientCountry,
