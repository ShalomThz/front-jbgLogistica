      ...
      <FormProvider {...flow.form}>
        ...
        {flow.step === "cobro" && (
          <CobroStep
            ...
            zoneId={flow.tariffZoneId}
            {...(flow.canChangeZone && { onZoneChange: flow.setZoneOverride })}
            serviceLevel={flow.tariffServiceLevel}
            onServiceLevelChange={flow.setServiceLevel}
            destinationCountry={flow.tariffDestinationCountry}
            onDestinationCountryChange={flow.setDestinationCountry}
            recipientCountry={flow.recipientCountry}
            shippingMode={flow.tariffShippingMode}
            priceType={flow.tariffPriceType}
            onPriceTypeChange={flow.setPriceType}
            boxId={flow.tariffBoxId}
            ...
            partnerTariff={flow.partnerTariff}
