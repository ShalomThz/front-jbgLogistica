...
/**
 * La zona vista como tabla: caja × servicio con los dos precios. Es como la lee
 * quien la usa —un vendedor cambia de zona y ve todo de un vistazo— y hace
 * visibles los huecos: una celda vacía es una tarifa que falta.
 */
