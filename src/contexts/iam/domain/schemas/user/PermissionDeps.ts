...
export const PERMISSION_DEPS: Partial<Record<Permission, Permission[]>> = {
  ...
  // Routes
  CAN_VIEW_ROUTES: ["CAN_LIST_ROUTES"],
  CAN_CREATE_ROUTES: ["CAN_LIST_ROUTES", "CAN_VIEW_ROUTES"],
  CAN_EDIT_ROUTES: ["CAN_LIST_ROUTES", "CAN_VIEW_ROUTES"],
  CAN_DELETE_ROUTES: ["CAN_LIST_ROUTES", "CAN_VIEW_ROUTES"],
  CAN_LIST_ALL_ROUTE_ORDERS: ["CAN_LIST_ROUTES"],

  // Drivers
  CAN_CREATE_DRIVERS: ["CAN_LIST_DRIVERS"],
  CAN_EDIT_DRIVERS: ["CAN_LIST_DRIVERS"],
