...
import type { StoreFiltersState, NameSort, DateSort } from "../../hooks/useStoreFilters";

interface StoreFiltersProps {
  filters: StoreFiltersState;
  limit: number;
  limitOptions: number[];
  setFilter: <K extends keyof StoreFiltersState>(key: K, value: StoreFiltersState[K]) => void;
  onLimitChange: (value: number) => void;
  onResetAndRefetch: () => void;
  onExport?: () => void;
}

const countActiveFilters = (filters: StoreFiltersState): number =>
      ...
      <Sheet>
        ...
        <SheetContent side="right" className="overflow-y-auto">
          <SheetHeader>
            ...
            <SheetDescription>Filtra y ordena las tiendas por diferentes criterios</SheetDescription>
          </SheetHeader>
