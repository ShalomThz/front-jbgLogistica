...
import type { UserFiltersState, NameSort, DateSort } from "../../hooks/useUserFilters";
...
const countActiveFilters = (filters: UserFiltersState): number =>
      ...
      <Sheet>
        ...
        <SheetContent side="right" className="overflow-y-auto">
          <SheetHeader>
            ...
            <SheetDescription>Filtra y ordena los usuarios por diferentes criterios</SheetDescription>
          </SheetHeader>
